...
// };
// console.log(maskCreditCard(534534523453453));
// console.log(maskCreditCard(6474736424));
// console.log(maskCreditCard('034953592832938239'));
...
// console.log(airline.indexOf('portugal')); // returns -1 when no match
